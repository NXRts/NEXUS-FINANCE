...
import { Filter, Download, ChevronLeft, ChevronRight, Eye, Plus, TrendingUp, ChevronDown, Check } from 'lucide-react';
    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="bg-white dark:bg-slate-900 p-2 md:p-3 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-2 w-full md:w-auto">
             <button className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-white font-bold text-sm shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex-1 md:flex-none">
                <Plus className="w-4 h-4" />
                <span>Add Expense</span>
            </button>
            <button className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg text-slate-500 hover:text-primary hover:bg-slate-50 dark:hover:bg-slate-800 font-bold text-sm transition-all md:w-auto">
                       ...
                       <td className="px-6 py-5">
                         <div className="flex items-center gap-2">
                            <div className={cn(
                                ...
                                expense.status === 'Menunggu' ? "bg-amber-500" : "bg-red-500"
                            )}></div>
                            <span className={cn(
                                "text-sm font-bold",
                                expense.status === 'Dibayar' ? "text-emerald-700 dark:text-emerald-400" : 
                                expense.status === 'Menunggu' ? "text-amber-700 dark:text-amber-400" : "text-red-700 dark:text-red-400"
                            )}>
                                {expense.status}
                            </span>
                         </div>
