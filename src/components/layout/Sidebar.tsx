...
import { LayoutDashboard, TrendingUp, TrendingDown, Layers, User, Wallet, X } from 'lucide-react';
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside className={cn(
      "w-72 flex-shrink-0 bg-slate-900 border-r border-slate-800 flex flex-col h-full transition-all duration-300 z-50",
